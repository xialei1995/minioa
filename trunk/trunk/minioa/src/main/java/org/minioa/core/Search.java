...
public class Search {
	...
	private List<Search> recordsList;

	public List<Search> getRecordsList() {
		if (recordsList == null)
			buildRecordsList();
		return recordsList;
	}
