...
public class Department {
	 ...
	 * @param desc
	 */
	public Department(int id, int cId, String cDate, int mId, String mDate, String uuid, int org, int parent, String name, String desc) {
		setID_(id);
		setCID_(cId);
		setCDATE(cDate);
		setMID_(mId);
	...
	public void buildRecordsList() {
		try {
			...
			while (it.hasNext()) {
				...
				recordsList.add(new Department(id, cId, cDate, mId, mDate, uuid, org, parent, name, desc));
				rowcount++;
			}
			it = null;
	...
	public void processSelection(NodeSelectedEvent event) {
		try {
			...
			depaName = bean.getDepaName();
			depaDesc = bean.getDepaDesc();
