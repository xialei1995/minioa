...
public class Form {
	...
	private String formName, tableName, notice, opType, enabledLog, enabledAtt, isPublish;
	...
	public void setOpType(String data) {
		opType = data;
	}
	...
	private List<Form> recordsList;

	public List<Form> getRecordsList() {
		if (recordsList == null)
			recordsList = new FormDao().buildRecordsList();
		return recordsList;
	}
